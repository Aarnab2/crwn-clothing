...
import { signInSuccess, signInFaliure, signOutSuccess, signOutFaliure, signUpFaliure, signUpSuccess } from './user.actions';
...
export function* userSagas() {
  yield all([
    ...
    call(onSignOutStart), call(onSignUpStart) , call(onSignUpStart) , call(onSignUpSuccess)
  ]);
}
